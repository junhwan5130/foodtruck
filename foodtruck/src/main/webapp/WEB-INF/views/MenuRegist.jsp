			...
			<div class="main-page">
				...
				<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-body">
								<form class="form-horizontal" action="insertMenu" method="post"> 
									...
									<div class="form-group"> 
										...
										<div class="col-sm-9"> 
										<input type="number" class="form-control" id="menu_price" name="menu_price" placeholder="Menu Price"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label for="inputEmail3" class="col-sm-2 control-label">Ingredients</label> 
										<div class="col-sm-9"> 
										<textarea rows="8" cols="40" id="menu_ingredients" name="menu_ingredients" placeholder="Menu Ingredients"></textarea>
										<!-- <input type="text" class="form-control" id="menu_ingredients" name="menu_ingredients" placeholder="Menu Ingredients"> --> 
										</div> 
									</div> 
									<!-- <div class="form-group"> 
									...
									<div class="col-sm-offset-2"> 
										<button type="submit" class="btn btn-default" id="reg">Regist</button> 
									</div>
