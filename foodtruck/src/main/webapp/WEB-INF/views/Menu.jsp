      ...
      <nav class="navbar navbar-inverse">
              ...
              <li class="treeview">
               ...
               <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="IngredientsTable"><i class="fa fa-angle-right"></i>Ingredients Tables</a></li>
		...
		<div id="page-wrapper">
			<div class="main-page general">
				...
				<ul class="bt-list">
						<li><a href="MenuRegist" class="hvr-icon-float-away col-1">ADD  </a></li>
				...
				<div class="panel-info widget-shadow">
					<!-- <h4 class="title2">Contextual alternatives :</h4> -->
						 ...
						 <div class="panel-heading"> <h3 class="panel-title">${mn.menu_name}</h3> </div>
						 <div class="panel-body">
						 Price: ${mn.menu_price} WON<br>
						 ${mn.menu_ingredients}<br>
						...
						<!-- <div class="panel-heading"> <h3 class="panel-title">Panel Default</h3> </div> 
						<div class="panel-body">
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin iaculis quam sit amet nisi dictum, in iaculis dolor lobortis. Aenean placerat purus non faucibus.
						</div>  -->
