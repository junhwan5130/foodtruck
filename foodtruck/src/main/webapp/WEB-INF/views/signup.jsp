            ...
            <div class="sign-up-row widget-shadow">
               ...
               <form action="signup" method="post">
                 ...
                 <!--  <div class="sign-u">
                  ...
                  <div class="sign-u">
                     <input type="email" name="emp_address" placeholder="Email Address" required="">
                     <div class="clearfix"></div>
                  </div>

                  <div>
                     <input type="text" name="emp_phone" placeholder="Phone Number" />
                  </div>

                  <div>
                     <input type="text" name="emp_bankcode" placeholder="Bankcode" />
                  </div>

                  <div>
                     <input type="text" name="emp_accountnum" placeholder="Account Number" />
                  </div>

                  <!-- <input type="hidden" id="emp_id" name="emp_id" value=""> -->
                  <h4>Position :</h4> 
                  <select name="emp_position" id="">
                  ...
                  <div class="sign-u">
                     <input type="text" name="emp_id" id="emp_id" placeholder="ID" required="">
                     <div class="clearfix"></div>
                  </div>
                  <div class="sign-u">
                     <input type="password" name="emp_pwd" id="emp_pwd1" placeholder="Password" required="">
                     <div class="clearfix"></div>
                  </div>
                  <div class="sign-u">
                     <input type="password" id="emp_pwd2" placeholder="Confirm Password" required="">
                  </div>
                  <div class="clearfix"></div>
                  <div class="sub_home">
