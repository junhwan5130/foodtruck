					...
					<div class="navbar-header">
						...
						<h1>
							<a class="navbar-brand" href="/app"><span
								...
								class="dashboard_text">Management System</span></a>
						</h1>
					</div>
					<div class="collapse navbar-collapse"
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview"><a href="index"> <i
									class="fa fa-dashboard"></i> <span>Employee Management</span>
							</a></li>
							<li class="treeview"><a href="#"> <i
									class="fa fa-laptop"></i> <span>Market Information</span> <i
									class="fa fa-angle-left pull-right"></i>
							</a>
								<ul class="treeview-menu">
									<li><a href="grids"><i class="fa fa-angle-right"></i>
											Charts</a></li>
									<li><a href="media"><i class="fa fa-angle-right"></i>
											Graphs</a></li>
								</ul></li>
							<li class="treeview"><a href="charts"> <i
									class="fa fa-pie-chart"></i> <span>Expenditure</span> <span
							...
							<li class="treeview"><a href="#"> <i
								...
								<ul class="treeview-menu">
									<li><a href="general"><i class="fa fa-angle-right"></i>
											General</a></li>
									<li><a href="icons"><i class="fa fa-angle-right"></i>
											Icons</a></li>
									<li><a href="buttons"><i class="fa fa-angle-right"></i>
											Buttons</a></li>
									<li><a href="typography"><i class="fa fa-angle-right"></i>
											Typography</a></li>
								</ul></li>
							<li><a href="widgets"> <i class="fa fa-th"></i> <span>Widgets</span>
							...
							<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
								...
								<ul class="treeview-menu">
									<li><a href="forms"><i class="fa fa-angle-right"></i>
											General Forms</a></li>
									<li><a href="validation"><i class="fa fa-angle-right"></i>
											Form Validations</a></li>
								</ul></li>
							<li class="treeview"><a href="#"> <i class="fa fa-table"></i>
									<span>Tables</span> <i class="fa fa-angle-left pull-right"></i>
							</a>
								<ul class="treeview-menu">
									<li><a href="tables"><i class="fa fa-angle-right"></i>
											Simple tables</a></li>
								</ul></li>
							<li class="treeview"><a href="#"> <i
								...
								<ul class="treeview-menu">
									<li><a href="inbox"><i class="fa fa-angle-right"></i>
											Mail Inbox</a></li>
									<li><a href="compose"><i class="fa fa-angle-right"></i>
											Compose Mail </a></li>
								</ul></li>
							<li class="treeview"><a href="#"> <i
								...
								<ul class="treeview-menu">
									...
									<li><a href="signup"><i class="fa fa-angle-right"></i>
											Register</a></li>
									<li><a href="404"><i class="fa fa-angle-right"></i>
											404 Error</a></li>
									<li><a href="500"><i class="fa fa-angle-right"></i>
											500 Error</a></li>
									<li><a href="blank-page"><i class="fa fa-angle-right"></i>
											Blank Page</a></li>
								</ul></li>
							...
							<li class="treeview"><a href="#"> <i
									class="fa fa-folder"></i> <span>OrderManagement</span> <i
									class="fa fa-angle-left pull-right"></i>
							</a>
								<ul class="treeview-menu">
									<li><a href="OrderRegist"><i class="fa fa-angle-right"></i>
											OrderRegist</a></li>
								</ul></li>
						</ul>
					</div>
			...
			<div class="main-page signup-page">
				...
				<div class="sign-up-row widget-shadow">
					...
					<form action="#" method="post">
						...
						<div>
							<input type="text" name="bankcode" placeholder="bankcode" />
						</div>

						<div>
							<input type="text" name="accountnum" placeholder="accountnumber" />
						</div>

						<input type="hidden" id="emp_id" name="emp_id" value="">
						<h4>Position :</h4> <select name="position" id="shelfname">
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
								<label> <input type="radio" name="Gender" required="">
									Male
								</label> <label> <input type="radio" name="Gender" required="">
									Female
								</label>
							</div>
