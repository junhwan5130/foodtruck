		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					...
					<div class="row">
						<h3 class="title1">Form Input :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal">
							
								<div class="form-group">
									<label for="cm_name" class="col-sm-2 control-label">Cooking Material Name </label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="cm_name" placeholder="Cooking Material Name">
									</div>
									
								</div>
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">Order Amount</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="orders_amount" placeholder="Order Amount (kg, g, ml,l)">
									...
									<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">Order Unit</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="order_unit" placeholder="Order Unit">
									</div>
								</div>
										
									<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">Order Unit Price</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="order_unitPrice" placeholder="Order Unit Price">
									</div>
								</div>
										
										<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">Order Date</label>
									<div class="col-sm-8">
										<input type="date" class="form-control1" id="order_date" >
									</div>
								</div>
										
										
									<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">Order Corporation</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="orders_corp" placeholder="Order Corporation">
									</div>
								</div>
								
								
								<div class="form-group">
									<label for="mediuminput" class="col-sm-2 control-label">Phone number</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="order_corpphone" placeholder="Order Corporation Phone number">
									</div>
								</div>
